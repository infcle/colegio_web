...
CREATE TABLE `intructivo` (
  ...
  `titulo` varchar(350) COLLATE utf8_spanish2_ci DEFAULT NULL,
  ...
  `ref` varchar(350) COLLATE utf8_spanish2_ci DEFAULT NULL,
...
insert  into `users`(`id`,`name`,`login`,`email`,`password`,`estado`,`rol`,`fecha_creacion`) values (1,'Juan Sergio Quispe Flores','admin','sergui@hakiari.com','$2y$10$lEJg5TFRUyp2h0cYVcU16u8zgTR8EDpSe9EdwUINQBMQVoG7rIqtm',1,'admin','2017-12-07 19:35:59');
