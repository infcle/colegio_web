	...
	$("#datos_publicacion").validate( {
		...
		submitHandler: function (form) {
			...
			$.ajax({
				...
				url: "ajax/agregar_instructivo.php",
				type: "post",
				beforeSend: function() {
				...
				success: function(response) {
					...
					if(response==1){						
						...
						respuesta="<script>"+
										"mensajes_alerta('ERROR REGISTRAR LOS DATOS !!','error','REGISTRO DE INSTRUCTIVO');"+
									"</script>";
...
function exito(){
	...
	mensajes_alerta('DATOS ALMACENADOS CORRECTAMENTE !! ','success','REGISTRO DE INSTRUCTIVO');
}